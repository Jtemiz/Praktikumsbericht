...
\begin{document}
    ...
    \section{Konzeption Visuelle Prüfung}
    \begin{itemize}
        \item Aufbau des Services \textit{Visuelle Prüfung}
    \end{itemize}


    \section{Umsetzung}
    \begin{itemize}
        \item Kerninhalte des Codes
        \item Wie bin ich auf die Inhalte gekommen?
        \item Abfolge der Algorithmen
    \end{itemize}
